    ...
    <div id="content">
        <div id="sidebar">
            <div class="sidebar-menu">
                ...
                <a href="customers.php"><button class="active"><i class="fa fa-tasks" aria-hidden="true"></i>Customers</button></a>
        ...
        <div id="main">
            <div class="page-title flex">
                <h2>Customers</h2>
                <a href='add-customer.php'><button class="apply"><i class="fa fa-plus-circle" aria-hidden="true"></i>Add new</button></a>
            </div>
            <div class="main-content" id="customers"></div>
        </div>
    </div>
</body>
</html>
