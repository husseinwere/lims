    ...
    <div id="content">
        ...
        <?php
            ...
            <div class="page-title flex">
                <h2>Project<!--<br><button class="link"><a href="edit-project.php?p=<?php //echo $project; ?>">Edit</a></button>--></h2>
                <button class="apply" id="contract-review"><i class="fa fa-download" aria-hidden="true"></i>Sample Receipt</button>
            </div>
                    ...
                    <form action="">
                        ...
                        <div class="input-flex">
                            <div class="input-box">
                                ...
                                <input type="text" value="<?php echo $amount_charged; ?>" disabled>
                            </div>
                            <div class="input-box">
                                <label for="">Receipt No.</label>
                                <input type="text" value="<?php echo $receipt_no; ?>" disabled>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="page-title flex">
                <h2>Samples</h2>
                <a href="receive-sample.php?p=<?php echo $project?>"><button class="apply">Add Sample</button></a>
            </div>
