    ...
    <div id="content">
        <div id="sidebar">
            <div class="sidebar-menu">
                ...
                <a href="projects.php"><button class="active"><i class="fa fa-files-o" aria-hidden="true"></i>Projects</button></a>
        ...
        <div id="main">
            <div class="page-title flex">
                <h2>Projects</h2>
                <a href='create-project.php'><button class="apply"><i class="fa fa-plus-circle" aria-hidden="true"></i>Add new</button></a>
            </div>
            <div class="main-content" id="projects"></div>
        </div>
    </div>
</body>
</html>
