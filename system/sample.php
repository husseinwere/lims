...
<body>
    ...
    <div id="content">
        ...
        <?php
                    ...
                    <form action="" id="logsample">
                        ...
                        <div class="input-flex">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" id="sampled_by" value="<?php echo $sampler; ?>" disabled>
                            </div>
                        </div>
                        <div class="input-flex">
                            <div class="input-box">
            ...
            <button class="apply del" id="deletesample"><i class="fa fa-trash" aria-hidden="true"></i>Delete Sample</button>
        </div>
    </div>
</body>
</html>
