...
<head>
    ...
    <title>HKT | Test Methods</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="css/style.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="js/test-methods.js"></script>
    ...
    <div id="content">
        <div id="sidebar">
            <div class="sidebar-menu">
                ...
                <a href="test-methods.php"><button class="active"><i class="fa fa-flask" aria-hidden="true"></i>Test Methods</button></a>
        ...
        <div id="main">
            <div class="page-title flex">
                <h2>Test Methods</h2>
                <a href='add-test-method.php'><button class="apply"><i class="fa fa-plus-circle" aria-hidden="true"></i>Add new</button></a>
            </div>
            <div class="main-content" id="test-methods"></div>
        </div>
    </div>
</body>
</html>
